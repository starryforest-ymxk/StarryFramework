...
namespace StarryFramework
{
    public class AudioComponent : BaseComponent
    {
        ...
        private void Start()
        {
            settings = FrameworkManager.setting.AudioSettings;
            FrameworkManager.eventManager.AddEventListener<int>(FrameworkEvent.OnNewActiveScene, OnNewActiveScene);
            FrameworkManager.eventManager.AddEventListener<int>(FrameworkEvent.InActiveCurrentScene, InActiveCurrentScene);
        }
        internal override void Shutdown() 
        {
            FrameworkManager.eventManager.RemoveEventListener<int>(FrameworkEvent.OnNewActiveScene, OnNewActiveScene);
            FrameworkManager.eventManager.RemoveEventListener<int>(FrameworkEvent.InActiveCurrentScene, InActiveCurrentScene);
        }
        ...
        public void PlayBGM(int index)
        {
            ...
            {
                UnityEngine.Debug.LogError("BGM index out of bound.");
            }
        }
