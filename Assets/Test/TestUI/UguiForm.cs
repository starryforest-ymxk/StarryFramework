...
public enum UIDynamicType {Static, Dynamic}
public enum UIChangeType {Fade, Cut}
    ...
    protected void SetVisible(bool visible)
    {
        ...
        switch (uiChangeType)
        {
            case UIChangeType.Fade:
                m_tweener = DOTween.To(()=> m_group.alpha, alpha => m_group.alpha = alpha,visible ? 1f : 0f, uiFadeDuration);
